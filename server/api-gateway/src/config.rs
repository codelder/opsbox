...
pub struct AppConfig {
    // 服务器配置
    #[arg(global = true, long, short = 'H', value_name = "HOST", default_value = "127.0.0.1", help = "监听地址")]
    pub host: String,
    ...
    // 数据库配置
    #[arg(long = "database-url", value_name = "URL", help = "数据库路径（覆盖 OPSBOX_DATABASE_URL）")]
...
impl AppConfig {
    ...
    pub fn get_worker_threads(&self) -> usize {
        self.worker_threads
            .or_else(|| Self::env_usize("LOGSEARCH_WORKER_THREADS"))
            .unwrap_or_else(|| {
    ...
    pub fn get_s3_max_concurrency(&self) -> usize {
        self.s3_max_concurrency
            .or_else(|| Self::env_usize("LOGSEARCH_S3_MAX_CONCURRENCY"))
            .unwrap_or(12)
            .clamp(1, 128)
    }
    ...
    pub fn get_cpu_concurrency(&self) -> usize {
        self.cpu_concurrency
            .or_else(|| Self::env_usize("LOGSEARCH_CPU_CONCURRENCY"))
            .unwrap_or(16)
            .clamp(1, 128)
    }
    ...
    pub fn get_stream_ch_cap(&self) -> usize {
        self.stream_ch_cap
            .or_else(|| Self::env_usize("LOGSEARCH_STREAM_CH_CAP"))
            .unwrap_or(256)
            .clamp(8, 10_000)
    }
    ...
    pub fn get_minio_timeout_sec(&self) -> u64 {
        self.minio_timeout_sec
            .or_else(|| Self::env_u64("LOGSEARCH_MINIO_TIMEOUT_SEC"))
            .unwrap_or(60)
            .clamp(5, 300)
    }
    ...
    pub fn get_minio_max_attempts(&self) -> u32 {
        self.minio_max_attempts
            .or_else(|| Self::env_u32("LOGSEARCH_MINIO_MAX_ATTEMPTS"))
            .unwrap_or(5)
            .clamp(1, 20)
    }
