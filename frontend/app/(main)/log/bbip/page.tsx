...
export default function Example() {
  ...
  return (
    <div className="h-full">
      ...
      <div className="hidden lg:inset-y-0 lg:z-50 lg:flex lg:w-96 lg:flex-col lg:p-4 lg:h-full">
        {/* Sidebar component, swap this element with another sidebar if you like */}
        <div className="flex flex-1 flex-col gap-y-5 overflow-y-auto  bg-white px-6">
          <h5
            id="drawer-label"
